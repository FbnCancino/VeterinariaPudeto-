...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference('Veterinario.count') do
      post veterinarios_url, params: { veterinario: { admin_id: @veterinario.admin_id, consulta_id: @veterinario.consulta_id, nombre: @veterinario.nombre, rut: @veterinario.rut, telefono: @veterinario.telefono } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { admin_id: @veterinario.admin_id, consulta_id: @veterinario.consulta_id, nombre: @veterinario.nombre, rut: @veterinario.rut, telefono: @veterinario.telefono } }
