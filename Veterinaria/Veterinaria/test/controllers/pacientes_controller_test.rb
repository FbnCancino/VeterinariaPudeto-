...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { cliente_id: @paciente.cliente_id, edad: @paciente.edad, nombre: @paciente.nombre, sexo: @paciente.sexo, tipo: @paciente.tipo } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cliente_id: @paciente.cliente_id, edad: @paciente.edad, nombre: @paciente.nombre, sexo: @paciente.sexo, tipo: @paciente.tipo } }
