...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference('Consultum.count') do
      post consulta_url, params: { consultum: { diagnostico: @consultum.diagnostico, fecha_llegada: @consultum.fecha_llegada, fecha_salida: @consultum.fecha_salida, paciente_id: @consultum.paciente_id, sintomas: @consultum.sintomas } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { diagnostico: @consultum.diagnostico, fecha_llegada: @consultum.fecha_llegada, fecha_salida: @consultum.fecha_salida, paciente_id: @consultum.paciente_id, sintomas: @consultum.sintomas } }
