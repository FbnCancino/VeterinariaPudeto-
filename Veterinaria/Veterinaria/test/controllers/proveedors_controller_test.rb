...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { admin_id: @proveedor.admin_id, mail: @proveedor.mail, nombre: @proveedor.nombre, rut: @proveedor.rut, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { admin_id: @proveedor.admin_id, mail: @proveedor.mail, nombre: @proveedor.nombre, rut: @proveedor.rut, telefono: @proveedor.telefono } }
