...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { fecha: @agenda.fecha, hora: @agenda.hora, veterinario_id: @agenda.veterinario_id } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { fecha: @agenda.fecha, hora: @agenda.hora, veterinario_id: @agenda.veterinario_id } }
